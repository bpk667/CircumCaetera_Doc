...
\newacronym{sqli}{SQLi}{Inyección SQL}
...
\newacronym{acme}{ACME}{Automatic Certificate Management Environment (ver estándar ACME \cite{rfc8555})}
\newacronym{cicd}{CI/CD}{Continuous Integration and Continuous Deployment or Continuous Delivery}
