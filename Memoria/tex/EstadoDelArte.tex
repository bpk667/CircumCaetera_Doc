...
\par Por último, ModSecurity es la solución de software libre más extendida y activa de la comunidad, y además implementa un número
significativo de los controles de seguridad deseables en un WAF. Por lo tanto, es el software base que se va a elegir para implementar nuestra
solución.
