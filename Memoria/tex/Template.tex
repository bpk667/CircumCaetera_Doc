...
% Se cambia el segundo nivel de enumerate al formato castellano ( "a)" )
\setlist[enumerate,2]{\emph{\alph*})}
\setlist[enumerate,2]{label   = \emph{\alph*}),
                      ref     = \theenumi.\emph{\alph*}}

% Se define que las secciones estén numeradas hasta tercer nivel (\subsubsection)
